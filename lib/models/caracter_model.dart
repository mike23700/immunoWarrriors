...
class UserAppCharacter extends AppCharacter {
  ...
  UserAppCharacter(
    ...
    _progression = (isProtector) ? progressLimit : progression;
  }

  bool progress() {
    if (_progression == progressLimit) return false;
    _progression++;
    return true;
  }
  ...
  Map<String, dynamic> toMap() {
    return {
      'character': super.toMap(),
      'progression': _progression,
      'quantity': quantity,
    };
  }

  factory UserAppCharacter.fromMap(Map<String, dynamic> map) {
    final appCharacter = AppCharacter.fromMap(map['character'] ?? map);
    final progression = map['progression'] ?? 0;
    final quantity = map['quantity'] ?? 0;
    return UserAppCharacter(
      appCharacter,
...
class FirestoreInitializer {
  ...
  final List<AppCharacter> protectors = [
    ...
    AppCharacter(
      ...
      attackData: [
        {'name': 'Tempête Cytokinique', 'damage': 20, 'range': 2, 'aoe': true},
        {
  ...
  final List<AppCharacter> pathogens = [
    AppCharacter(
      ...
      attackData: [
        ...
        {'name': 'Division Cellulaire', 'effect': 'Invoque Unité', 'unitId': 0},
      ],
    ),
    AppCharacter(
      id: 1,
    ...
    AppCharacter(
      ...
      attackData: [
        ...
        {'name': 'Mutation Incohérente', 'effect': 'Saut de Cible', 'range': 4},
      ],
    ),
    AppCharacter(
      id: 6,
    ...
    AppCharacter(
      ...
      attackData: [
        ...
        {'name': 'Camouflage Cellulaire', 'effect': 'Évitement', 'duration': 1},
      ],
    ),
  ];
